...
| --- | --- | --- |
| `SdfSphere` | 球 | `position`, `rotation`, `radius`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfBox` | 箱 | `position`, `rotation`, `size`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfCylinder` | 円柱 | `position`, `rotation`, `radius`, `height`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfCone` | 円錐・円錐台 | `position`, `rotation`, `topRadius`, `bottomRadius`, `height`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfCapsule` | capsule・任意軸円柱 | `position`, `rotation`, `top`, `bottom`, `radius`, `round`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfTorus` | トーラス | `position`, `rotation`, `majorRadius`, `minorRadius`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfEllipsoid` | 楕円球 | `position`, `rotation`, `radii`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfTetrahedron` | 正四面体 | `position`, `rotation`, `radius`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfOctahedron` | 正八面体 | `position`, `rotation`, `radius`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfDodecahedron` | 正十二面体 | `position`, `rotation`, `radius`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfIcosahedron` | 正二十面体 | `position`, `rotation`, `radius`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfFunction` | WGSL文字列で定義する汎用SDF | `position`, `rotation`, `sdfFunction`, `data0`, `data1`, `data2`, `bounds`, `color`, `smoothness`, `material`, `materialUniform` |
| `SdfGroup` | 子SDFのboolean合成 | `op`, `position`, `rotation`, `smoothness`, `material`, `materialUniform`, `children` |
