...
const ACTIVE_SCENE_STORAGE_KEY = "nexusgpu.myDemo.activeSceneId";
const RENDER_SETTINGS_STORAGE_KEY = "nexusgpu.myDemo.renderSettings";
const SCENE_PARAMETERS_STORAGE_KEY = "nexusgpu.myDemo.sceneParametersBySceneId";
