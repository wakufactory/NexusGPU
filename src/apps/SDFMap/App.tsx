...
import { DEFAULT_SCENE_ID, getSceneDefinition, SCENES, type SceneId } from "./scenes/registry";
import type { NexusRenderSettings, NexusRenderStats } from "../../nexusgpu";
import type { AnyNexusSceneDefinition } from "./scenes/types";

const ACTIVE_SCENE_STORAGE_KEY = "nexusgpu.sdfMap.activeSceneId";
const RENDER_SETTINGS_STORAGE_KEY = "nexusgpu.sdfMap.renderSettings";
const SCENE_PARAMETERS_STORAGE_KEY = "nexusgpu.sdfMap.sceneParametersBySceneId";
const IS_SINGLE_SCENE_BUILD = false;
...
/** Height map SDF scenesを切り替えて表示する独立アプリ。 */
export function App() {
    ...
    <main ref={shellRef} className={isFullscreen ? "app-shell is-fullscreen" : "app-shell"}>
      ...
      <aside className="sidebar">
        ...
        <div className="brand">
          ...
          <div>
            <h1>SDFMap</h1>
            <p>Height map scenes rendered with NexusGPU.</p>
          </div>
        </div>
      </aside>
    </main>
